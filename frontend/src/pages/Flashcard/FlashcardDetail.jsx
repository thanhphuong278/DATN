...
import { getFlashcardDetail, copyFlashcard } from "../../api/flashcardApi";
  ...
  return (
    <div className="detail-container">
      ...
      <div className="action-bar">
        <button className="" onClick={() => navigate(`/study/${id}`)}>
          Học Flashcard
        </button>

        <button className="secondary">Trắc nghiệm</button>

        {isOwner && (
          <button onClick={() => navigate(`/flashcard/edit/${id}`)}>Sửa</button>
        )}

        {data.isPublic && <button className="secondary">Share</button>}
